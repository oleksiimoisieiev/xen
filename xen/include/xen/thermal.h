...
//TODO cleanup after both rcar and imx drivers will be rewritten
struct thermal_sensor_ops {
    int (*get_temp) (void *, int *); //TODO set void * or sensor?
...
struct thermal_governor {
    ...
    int     (*throttle)(int sensor_id, struct thermal_sensor *sensor,
                        int trip);
    bool_t  (*handle_option)(const char *name, const char *value); //TODO do I need this?
    struct list_head governor_list;
};

//TODO make posibility to enable_disable each governor
//TODO remove bang bang governor as it works only with cooling. or not?
